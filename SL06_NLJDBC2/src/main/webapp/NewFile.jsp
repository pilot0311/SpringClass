...
<h3><a target="_blank" href="/customer/notice.htm">notice</a></h3>
  <xmp class="code">
  	1. namedParameterJdbcTemplate 객체 사용 예제
  		1) root-context.xml
  	2. org.doit.ik.persistence 패키지 --DAO
  		MemberDAO.java 인터페이스
  		MemberDAOImpl.java 클래스
  		NoticeDAO.java 인터페이스
  		NoticeDAOImpl.java 클래스
  	3. index.jsp -> *.htm 요청
  		HomeController.java 수정
  	4. org.doit.ik.controller 패키지 안에
  		JoinController.java 추가  -> 회원가입/로그인 처리
  </xmp>
  <xmp class="code">
