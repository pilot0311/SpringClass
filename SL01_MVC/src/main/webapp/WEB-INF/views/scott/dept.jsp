...
<body>
	<header>
		<h1 class="main">
			<a href="#" style="position: absolute; top: 30px;">pilot0311
				Spring HOme</a>
		</h1>
		<ul>
			<li><a href="#">로그인</a></li>
	...
	<div>
		<xmp class="code"> /scott/dept.jsp </xmp>
  ...
  <div class="modal-content">
	...
	<script>
		$(function() {
			...
			$("#tbl-dept > tbody > tr > td > span").on("click",function(){
				if (confirm("정말 삭제 할까요?")) {
					let deptno = $(this).data("deptno");
					deptService.remove(deptno,function(){
						if (result === 'SUCCESS') {
